...
from model.model import MtyMindConfig, MtyMindForCausalLM
...
def init_model(args):
    ...
    print(
        f"MtyMind模型参数: {sum(p.numel() for p in model.parameters()) / 1e6:.2f} M(illion)"  # ！修正：原残留MiniMind命名
    )
